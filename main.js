...
const todosHandler = (function () {
  ...
  const render = () => {
    refreshTodoList();
    renderTodos();
    _todos_helper__WEBPACK_IMPORTED_MODULE_2__.todosHelper.initializeScrollWheel();
  };
